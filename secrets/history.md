...
The empire brought its strange beliefs and built its monuments alongside the ones that existed before and it all went relatively smoothly for a long time. Mostly because the empire didn't care to do much, leaving all the local polities to keep on going their own way. [Ikizh](Ikizh.md) and [Rundan](Rundan.md) were the connection points to the empire and its rivals like the [Hakonaga](Hakonaga.md).
...
Around the [Nuoro River](NuoroRiver.md) there were Dragons and Fae, sapients of all sorts, with their own kingdoms and intrigues. [Dwarves](Dwarf.md) ruled in the [Grimteeth](Grimteeth.md) mountains, having once wrested a hoard there from an ancient dragon. The fickle [Eladrin](Eladrin.md) haunted the [Kanliwood](Kanliwood.md) and [Karanliwood](Karanliwood.md) while [Perolmani](Perolmani.md) was the [Gnome](Gnome.md) homeland. [Goliath](Goliath.md) clans ruled the far northwest.
# A Sketch of Civilization

> notes on empire: Happily, many moderns like to pay lip-service to a set of values inconsistent with celebrating “we are going to steal their stuff while killing as many as it takes for them to stop trying to prevent us from stealing their stuff.” At the same time, they are utterly determined to pillage the world, so there’s a healthy supply of seemingly benevolent justifications for empires. These include (but are not limited to): - Large scale infrastructure projects beyond the economic means of small nations, such as Roman roads and Chinese canal systems. - Expanded, improved trade networks, as seen after the Mongol Empire (too bad about the Black Death). - Bringing civilized values to benighted cultures unlikely to self-illuminate; the obvious example being CBC, CTV, and Global programs leaking south across the border. - Mutual defense against a fearsome internal or external enemy, such as the protection, such as it was, the British Empire provided Canada from a southern neighbour who might otherwise have sacked our towns, burned our households, desecrated our holy places, enslaved our children, and forced us to spell words incorrectly.
