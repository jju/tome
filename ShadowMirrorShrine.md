...
Inside the archway is an obviously constructed place. The walls are mortared stone with 12-foot high ceilings. The first room (the central #1 on the above map) from this direction is circular with statues of three [tentacle-faced humanoids](Cephalopoid.md) lifting their arms upward. There are also mirrors on the walls in oddly asymmetric places.
...
In an intersection room (#4) there's a full-size mirror directly behind a door. It is host to more distortion effects for those susceptible and is remarkably solid.

The hall of mirrors (#5) amplifies to a dazzling degree any light source brought in. The walls and ceiling are all mirrored and the floor is a bright white stone. There's a a large double-sided mirror in the centre of the room that people can walk around. These mirrors reflect a malevolent sinister version of the subject.
