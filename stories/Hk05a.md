...
* DC10 History (Cha) - Can get in and find some official local history type things
	...
	* DC5 can get some basic information on the [ClanSnowcoat](ClanSnowcoat.md) 
...
Downside is they will be connected with nefarious witches and such

* DC15 Investigation (Int/Cha)
	* The [Luxon Shrine](LuxonShrineHk.md) and its arcane possibilities exist
	* 
* DC5 Arcane (Cha)
	* Can get in with some listening to proselytyzing
	* The last warlock in [Hammerkeep](Hammerkeep.md) executed 20 years ago under the authority of the TempleErathis
	* [WyrmshoodPact](WyrmshoodPact.md) - depicted as diplomatic arrangement no mention of how [BranchGolem](BranchGolem.md) was made
	* [Cephalopoids](Cephalopoid.md) are an otherworldly menace who attack good humanoids' minds directly
	* 
...
* find library with information on these things 
	* keep has a library but the sage is looking after that
...
* find people who have encountered these before
	* magical people
		...
		* [Eager Wave](EagerWave.md)
		* the weird little reading room by [Truthhauler's](ThalaneTruthhaulerKalukithino.md) smith
	* forest people
		* best tavern - Mourning Forest
		* Thalin the weird recluse hunter [Dragonborn](Dragonborn.md) guy roaming in the Karanliwood
* examine the body and do science on it
	* has to be done within 3 days of returning to [Hammerkeep](Hammerkeep.md) ([Iall 08 IC4996](IC4996.md)) or the body has dissolved
	* testing (DC 10 Investigation (Int)) can discover who can see it (probably find the mirror thing, but not the candle technique (DC20))

## Swirly Orb

* find library with information on this thing
	* keep has a library but letting the authorities know will probably get the orb confiscated
	* send message to [Bedwistre](Bedwistre.md) where some temples (probably to [Ioun](Ioun.md)) would have even better library but letting the authorities know will probably get the orb confiscated
	* castle yarg was supposed to have an amazing library and some say it survived the [Arcane Purge](ArcanePurge.md) - not sure where it is, but off towards [Ikizh](Ikizh.md)
	* the weird little reading room by [Truthhauler's](ThalaneTruthhaulerKalukithino.md) smith
* find people who have encountered these before
	* magical people
		...
		* the weird little reading room by [Truthhauler's](ThalaneTruthhaulerKalukithino.md) smith
	* criminal people
		* Zan's Tradehouse - centerpiece for smuggling
		* The [OldGoatTavern](OldGoatTavern.md) in the docks
