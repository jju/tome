...
***Fire Ballistas.*** The ship can fire its [ballista](ballista.md).

***Fire Mangonel.*** The galley can fire its [mangonel](mangonel.md).
...
_Ranged Weapon Attack:_ +6 to hit, range 120/480 ft., one target. _Hit:_ 16 (3d10) piercing damage.
...
_Ranged Weapon Attack:_ +5 to hit, range 200/800 ft. (can't hit targets within 60 ft. of it), one target. _Hit:_ 27 (5d10) bludgeoning damage.
...
- One captain ([banditcaptain](banditcaptain.md))
- Four other officers: a first mate, a bosun, a quartermaster, and a cook ([noble](noble.md#NPC%20Nobles))
- Twenty-five sailors ([commoner](commoner.md))
...
**Mangonel.** Sailing ships have one **mangonel** attached to the deck. Warships have two **mangonels**. Each weapon has 10 mangonel stones stacked and secured near it.
...
**Rowboats.** Four [rowboats](https://www.dndbeyond.com/vehicles/rowboat) are stacked on top of each other on this deck. Ropes and pulleys can hoist these boats in and out of the water.
...
This cabin is meant for guests and visiting high-ranking officials along for the journey. Since warships often have a greater need to house prisoners rather than guests, each bed aboard such a vessel also has a set of [manacles](manacles.md) attached to its frame.
...
> source: https://www.dndbeyond.com/vehicles/sailing-ship
> vehicles 