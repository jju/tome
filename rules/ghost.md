...
**_Horrific Visage._** _Wisdom Saving Throw:_ DC 13, each creature in a 60-foot Cone that can see the ghost and isn’t an Undead. _Failure:_ 10 (2d6 + 3) Psychic damage, and the target has the [Frightened](https://www.dndbeyond.com/sources/dnd/free-rules/rules-glossary#FrightenedCondition) condition until the start of the ghost’s next turn. _Success:_ The target is immune to this ghost’s Horrific Visage for 24 hours.
