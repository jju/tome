...
When you choose this feat, you acquire a ritual book holding two 1st-level spells of your choice. Choose one of the following classes: [bard](https://dnd-5e.fandom.com/wiki/Bard_Spells "Bard Spells"), [cleric](https://dnd-5e.fandom.com/wiki/Cleric_Spells "Cleric Spells"), [druid](https://dnd-5e.fandom.com/wiki/Druid_Spells "Druid Spells"), [sorcerer](https://dnd-5e.fandom.com/wiki/Sorcerer_Spells "Sorcerer Spells"), [warlock](https://dnd-5e.fandom.com/wiki/Warlock_Spells "Warlock Spells"), or [wizard](https://dnd-5e.fandom.com/wiki/Wizard_Spells "Wizard Spells"). You must choose your spells from that class's spell list, and the spells you choose must have the ritual tag. The class you choose also determines your spellcasting ability for these spells: Charisma for bard, sorcerer, or warlock; Wisdom for cleric or druid; or Intelligence for wizard.
...
|---|---|---|
|Lorehold|Choose two from [Light](https://dnd-5e.fandom.com/wiki/Light "Light"), [Sacred Flame](https://dnd-5e.fandom.com/wiki/Sacred_Flame "Sacred Flame"), and [Thaumaturgy](https://dnd-5e.fandom.com/wiki/Thaumaturgy "Thaumaturgy").|Choose one 1st-level [cleric](https://dnd-5e.fandom.com/wiki/Cleric_Spells "Cleric Spells") or [wizard](https://dnd-5e.fandom.com/wiki/Wizard_Spells "Wizard Spells") spell.|
|Prismari|Choose two from [Fire Bolt](https://dnd-5e.fandom.com/wiki/Fire_Bolt "Fire Bolt"), [Prestidigitation](https://dnd-5e.fandom.com/wiki/Prestidigitation "Prestidigitation"), and [Ray of Frost](https://dnd-5e.fandom.com/wiki/Ray_of_Frost "Ray of Frost").|Choose one 1st-level [bard](https://dnd-5e.fandom.com/wiki/Bard_Spells "Bard Spells") or [sorcerer](https://dnd-5e.fandom.com/wiki/Sorcerer_Spells "Sorcerer Spells") spell.|
|Quandrix|Choose two from [Druidcraft](https://dnd-5e.fandom.com/wiki/Druidcraft "Druidcraft"), [Guidance](https://dnd-5e.fandom.com/wiki/Guidance "Guidance"), and [Mage Hand](https://dnd-5e.fandom.com/wiki/Mage_Hand "Mage Hand").|Choose one 1st-level [druid](https://dnd-5e.fandom.com/wiki/Druid_Spells "Druid Spells") or [wizard](https://dnd-5e.fandom.com/wiki/Wizard_Spells "Wizard Spells") spell.|
...
- Increase your Constitution score by 1, to a maximum of 20.
- You learn a cantrip of your choice from the [sorcerer spell list](https://dnd-5e.fandom.com/wiki/Sorcerer_Spells "Sorcerer Spells"). In addition, choose a 1st-level spell from the sorcerer spell list. You learn that spell and can cast it through your mark. Once you cast it, you must finish a short or long rest before you can cast it again through the mark. Constitution is your spellcasting ability for these spells.
...
- **Instinctive Spellcasting.** You learn the **Shield** spell. You can cast it **once per long rest** without expending a spell slot. If you already know or can cast spells, it counts as a known or prepared spell for you, and you can cast it using your spell slots as normal.
...
- Increase your **Strength** or **Dexterity** score by 1, to a maximum of 20.
- While wielding a **versatile weapon in one hand**, the weapon’s damage die increases by **one step** (e.g., from 1d8 to 1d10).
- When you take the **Attack action** on your turn and make at least one attack with a versatile weapon wielded in one hand, you can make **one additional weapon attack** as part of that action.
...
_Prerequisite: 8th level, have a dragonmark_
...
- You learn a set of spells, each of which you can cast once without expending a spell slot or using a material component. The list of spells and the spellcasting ability for them are shown on the Greater Dragonmark Benefits table. You must complete a long rest to use the spells again, except in the case of Scribing and Sentinel, where you only must complete a short rest.

To cast [Leomund's Secret Chest](https://dnd-5e.fandom.com/wiki/Leomund%27s_Secret_Chest "Leomund's Secret Chest") using this feat and the Mark of Warding, you must have a Siberys dragonshard with a value of at least 100 gp. It serves as a focus for the spell and replaces the tiny chest's replica.

|Dragonmark|Ability|Spells|Spellcasting Ability|
|---|---|---|---|
|Mark of Detection|Charisma or Intelligence|[See Invisibility](https://dnd-5e.fandom.com/wiki/See_Invisibility "See Invisibility"), [True Seeing](https://dnd-5e.fandom.com/wiki/True_Seeing "True Seeing")|Intelligence|
|Mark of Finding|Dexterity, Strength, or Wisdom|[Locate Creature](https://dnd-5e.fandom.com/wiki/Locate_Creature "Locate Creature"), [Find the Path](https://dnd-5e.fandom.com/wiki/Find_the_Path "Find the Path")|Wisdom|
|Mark of Handling|Dexterity or Wisdom|[Beast Sense](https://dnd-5e.fandom.com/wiki/Beast_Sense "Beast Sense"), [Dominate Beast](https://dnd-5e.fandom.com/wiki/Dominate_Beast "Dominate Beast")|Wisdom|
|Mark of Healing|Dexterity or Wisdom|[Mass Healing Word](https://dnd-5e.fandom.com/wiki/Mass_Healing_Word "Mass Healing Word"), [Greater Restoration](https://dnd-5e.fandom.com/wiki/Greater_Restoration "Greater Restoration")|Wisdom|
|Mark of Hospitality|Dexterity or Charisma|[Sanctuary](https://dnd-5e.fandom.com/wiki/Sanctuary "Sanctuary"), [Mordenkainen's Magnificent Mansion](https://dnd-5e.fandom.com/wiki/Mordenkainen%27s_Magnificent_Mansion "Mordenkainen's Magnificent Mansion")|Charisma|
|Mark of Making|Dexterity or Intelligence|[Fabricate](https://dnd-5e.fandom.com/wiki/Fabricate "Fabricate"), [Creation](https://dnd-5e.fandom.com/wiki/Creation "Creation")|Intelligence|
|Mark of Passage|Dexterity or Constitution|[Blink](https://dnd-5e.fandom.com/wiki/Blink "Blink"), [Teleportation Circle](https://dnd-5e.fandom.com/wiki/Teleportation_Circle "Teleportation Circle")|Constitution|
|Mark of Scribing|Intelligence or Charisma|[Sending](https://dnd-5e.fandom.com/wiki/Sending "Sending"), [Tongues](https://dnd-5e.fandom.com/wiki/Tongues "Tongues")|Intelligence|
|Mark of Sentinel|Strength or Wisdom|[Compelled Duel](https://dnd-5e.fandom.com/wiki/Compelled_Duel "Compelled Duel"), [Warding Bond](https://dnd-5e.fandom.com/wiki/Warding_Bond "Warding Bond")|Wisdom|
|Mark of Shadow|Charisma or Dexterity|[Nondetection](https://dnd-5e.fandom.com/wiki/Nondetection "Nondetection"), [Mislead](https://dnd-5e.fandom.com/wiki/Mislead "Mislead")|Charisma|
...
- **Clockwork Toy:** This toy is a clockwork animal, monster, or person, such as a frog, mouse, bird, dragon, or soldier. When placed on the ground, the toy moves 5 feet across the ground on each of your turns in a random direction.
