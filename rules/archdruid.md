...
***Wildfire.** Ranged Spell Attack:* +9 to hit, range 120 ft., one tar-get. *Hit:* 26 (6d6 + 5) fire damage, and the target is blinded until the start of the druid's next turn.
