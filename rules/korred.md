...
Small [Fey](Fey.md), Typically Chaotic Neutral
...
***Spellcasting.*** The korred casts one of the following spells, requiring no spell components and using Wisdom as the spell. casting ability (spell save DC 13):
